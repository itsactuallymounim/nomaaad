...
const destinations = [
  { city: 'Tokyo', country: 'Japan', tagline: 'Where tradition meets the future', unsplashId: 'photo-1503899036084-c55cdd92da26', color: 'from-foreground/60' },
  ...
  { city: 'New York', country: 'United States', tagline: 'The city that never sleeps', unsplashId: 'photo-1496588152823-86ff7695e68f', color: 'from-foreground/60' },
  { city: 'Barcelona', country: 'Spain', tagline: 'Art, architecture and tapas', unsplashId: 'photo-1630219694734-fe47ab76b15e', color: 'from-foreground/60' },
  { city: 'Bali', country: 'Indonesia', tagline: 'Island of the gods', unsplashId: 'photo-1604999333679-b86d54738315', color: 'from-foreground/60' },
  ...
  { city: 'Santorini', country: 'Greece', tagline: 'Sunsets over the caldera', unsplashId: 'photo-1678266561093-324802646fb2', color: 'from-foreground/60' },
  ...
  { city: 'Marrakech', country: 'Morocco', tagline: 'A sensory feast of colour and spice', unsplashId: 'photo-1580746738099-1cb74f972feb', color: 'from-foreground/60' },
  ...
  { city: 'Lisbon', country: 'Portugal', tagline: 'Seven hills of fado and sunshine', unsplashId: 'photo-1558102400-72da9fdbecae', color: 'from-foreground/60' },
  { city: 'Berlin', country: 'Germany', tagline: 'Creative capital of Europe', unsplashId: 'photo-1566404791232-af9fe0ae8f8b', color: 'from-foreground/60' },
  { city: 'Buenos Aires', country: 'Argentina', tagline: 'Tango, steak and bohemian soul', unsplashId: 'photo-1679417302656-9b5170584526', color: 'from-foreground/60' },
  { city: 'Seoul', country: 'South Korea', tagline: 'K-culture and street food heaven', unsplashId: 'photo-1532649097480-b67d52743b69', color: 'from-foreground/60' },
  { city: 'Dubai', country: 'UAE', tagline: 'Futuristic skyline and desert adventures', unsplashId: 'photo-1518684079-3c830dcef090', color: 'from-foreground/60' },
  { city: 'Prague', country: 'Czech Republic', tagline: 'Fairytale architecture and great beer', unsplashId: 'photo-1600623471616-8c1966c91ff6', color: 'from-foreground/60' },
  ...
  { city: 'Reykjavik', country: 'Iceland', tagline: 'Northern lights and geothermal pools', unsplashId: 'photo-1602167352652-52dba4750482', color: 'from-foreground/60' },
  { city: 'Singapore', country: 'Singapore', tagline: 'Ultra-modern city-state with amazing food', unsplashId: 'photo-1508964942454-1a56651d54ac', color: 'from-foreground/60' },
  ...
  { city: 'Lima', country: 'Peru', tagline: 'Gastronomic capital of South America', unsplashId: 'photo-1577587230708-187fdbef4d91', color: 'from-foreground/60' },
  { city: 'Edinburgh', country: 'Scotland', tagline: 'Historic charm and stunning hilltop views', unsplashId: 'photo-1535448033526-c0e85c9e6968', color: 'from-foreground/60' },
];
