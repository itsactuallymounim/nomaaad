...
import {
  ...
  Brain, Zap, Shield, Plane, FileText, AlertTriangle, Timer, Search } from
'lucide-react';
...
{ id: '1', name: 'Canggu, Indonesia', city: 'Canggu', country: 'Indonesia', category: 'cat.coworking', image: '1546484458-6904289cd4f0', description: 'Surf, cowork and chill in Bali\'s digital nomad capital.', span: 'normal' },
...
{ id: '3', name: 'Barcelona, Spain', city: 'Barcelona', country: 'Spain', category: 'cat.food', image: '1630219694734-fe47ab76b15e', description: 'Vibrant food markets, stunning architecture and Mediterranean vibes.', span: 'normal' },
...
{ id: '5', name: 'Lisbon, Portugal', city: 'Lisbon', country: 'Portugal', category: 'cat.coliving', image: '1558102400-72da9fdbecae', description: 'Affordable coliving, great weather and a thriving nomad community.', span: 'tall' },
{ id: '6', name: 'Ubud, Indonesia', city: 'Ubud', country: 'Indonesia', category: 'cat.explore', image: '1628697723581-fd4ec5c38ab0', description: 'Relax and rejuvenate among Bali\'s lush rice terraces and vibrant culture.', span: 'normal' },
{ id: '7', name: 'Chiang Mai, Thailand', city: 'Chiang Mai', country: 'Thailand', category: 'cat.coworking', image: '1599576838688-8a6c11263108', description: 'Affordable living, amazing food and a legendary digital nomad scene.', span: 'normal' },
...
{ id: '9', name: 'Medellín, Colombia', city: 'Medellín', country: 'Colombia', category: 'cat.coworking', image: '1715503234327-b57d32e5da0f', description: 'Perfect weather year-round with a booming coworking culture.', span: 'normal' },
{ id: '10', name: 'Marrakech, Morocco', city: 'Marrakech', country: 'Morocco', category: 'cat.coliving', image: '1580746738099-1cb74f972feb', description: 'A magical city full of colour, spice markets and hidden riads.', span: 'normal' },
{ id: '11', name: 'Ho Chi Minh, Vietnam', city: 'Ho Chi Minh', country: 'Vietnam', category: 'cat.cafes', image: '1583417319070-4a69db38a482', description: 'Incredible street food, cheap coffee, and buzzing energy.', span: 'normal' },
{ id: '12', name: 'Mexico City, Mexico', city: 'Mexico City', country: 'Mexico', category: 'cat.food', image: '1601585144584-2a53183be14c', description: 'Rich culture, world-class tacos and a growing remote work scene.', span: 'tall' },
{ id: '13', name: 'Tokyo, Japan', city: 'Tokyo', country: 'Japan', category: 'cat.explore', image: '1503899036084-c55cdd92da26', description: 'Neon-lit streets, ancient shrines and the best ramen on earth.', span: 'normal' },
{ id: '14', name: 'Berlin, Germany', city: 'Berlin', country: 'Germany', category: 'cat.coworking', image: '1566404791232-af9fe0ae8f8b', description: 'Creative capital of Europe with affordable coworking and nightlife.', span: 'tall' },
{ id: '15', name: 'Buenos Aires, Argentina', city: 'Buenos Aires', country: 'Argentina', category: 'cat.food', image: '1679417302656-9b5170584526', description: 'Tango, steak and a bohemian vibe that never gets old.', span: 'normal' },
...
{ id: '18', name: 'New York, United States', city: 'New York', country: 'United States', category: 'cat.explore', image: '1496588152823-86ff7695e68f', description: 'The city that never sleeps — endless energy and inspiration.', span: 'tall' },
{ id: '19', name: 'Dubrovnik, Croatia', city: 'Dubrovnik', country: 'Croatia', category: 'cat.explore', image: '1714236315612-9ccb56e376ca', description: 'Medieval walls meet crystal-clear Adriatic waters.', span: 'normal' },
{ id: '20', name: 'Seoul, South Korea', city: 'Seoul', country: 'South Korea', category: 'cat.cafes', image: '1532649097480-b67d52743b69', description: 'K-culture, incredible street food and lightning-fast wifi.', span: 'normal' },
{ id: '21', name: 'Playa del Carmen, Mexico', city: 'Playa del Carmen', country: 'Mexico', category: 'cat.coworking', image: '1726147417354-cf82fb0548af', description: 'Beach life meets coworking on the Caribbean coast.', span: 'normal' },
{ id: '22', name: 'Prague, Czech Republic', city: 'Prague', country: 'Czech Republic', category: 'cat.cafes', image: '1600623471616-8c1966c91ff6', description: 'Fairytale architecture, great beer and a thriving café scene.', span: 'tall' },
{ id: '23', name: 'Taipei, Taiwan', city: 'Taipei', country: 'Taiwan', category: 'cat.food', image: '1598935898639-81586f7d2129', description: 'Night markets, bubble tea and a tech-savvy nomad paradise.', span: 'normal' },
{ id: '24', name: 'Santorini, Greece', city: 'Santorini', country: 'Greece', category: 'cat.explore', image: '1678266561093-324802646fb2', description: 'Breathtaking sunsets over white-washed cliffs and blue domes.', span: 'normal' }];
