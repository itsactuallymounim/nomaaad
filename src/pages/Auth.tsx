      ...
      >
        <Card className="rounded-3xl border-border/50 shadow-xl backdrop-blur-sm">
          <CardHeader className="text-center pb-4">
            ...
            <CardTitle className="text-2xl font-serif">Welcome to nomaaad</CardTitle>
          ...
          <CardContent>
            ...
            <Tabs defaultValue="signin">
              <TabsList className="grid w-full grid-cols-2 mb-5 rounded-2xl h-10">
              ...
              <TabsContent value="signin">
                <form onSubmit={handleSignIn} className="space-y-4">
                  ...
                  <Button type="submit" className="w-full rounded-2xl h-11" disabled={isSubmitting}>
